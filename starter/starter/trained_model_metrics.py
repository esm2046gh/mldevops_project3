...
if __name__ == "__main__":
    ...
    model = dump.load(f'../model/model.pkl')
    train = dump.load(f'../model/train.pkl')
    test = dump.load(f'../model/test.pkl')
    cat_features = dump.load(f'../model/cat_features.pkl')
    output_feature = dump.load(f'../model/output_feature.pkl')
    encoder = dump.load(f'../model/encoder.pkl')
    lb = dump.load(f'../model/lb.pkl')
    scaler = dump.load(f'../model/scaler.pkl')
